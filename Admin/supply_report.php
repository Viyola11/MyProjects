                ...
                <div class="panel">
                                <div class="panel-body table-responsive">
                                   <table  border=1 id="printDoc">  
									<tr><th colspan="2"><h3>SUPPLY METHOD INFORMATION</h3></th></tr>                        
                    <tr>
                        <th>Type ID</th>
                        <th>Type Name</th>                             
                    </tr>
<?php
   ...
   // $actions=array('edit'=>array('label'=>'Edit','link'=>'edit_racksupply.php','params'=>array('type_id'=>'type_id'),'attributes'=>array('class'=>'btn btn-success')),
    //'delete'=>array('label'=>'Delete','link'=>'edit_racksupply.php','params'=>array('type_id'=>'type_id'),'attributes'=>array('class'=>'btn btn-success')));

   // $config=array('srno'=>true,'hiddenfields'=>array('type_id'));

   
 $fields=array('type_id','type_name');
    $users=$da->selectAsTable($fields,'type_mgne','status=0',null,null,null);
